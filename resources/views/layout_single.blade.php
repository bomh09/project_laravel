                    ...
                    <div class="col-sm-8">
                        <div class="shop-menu pull-right">
                            <ul class="nav navbar-nav">
                                ...
                                <li><a href="{{ URL::to('/show-cart') }}"><i class="fa fa-shopping-cart"></i> Giỏ hàng
                                ...
                                <li><a href="{{ URL::to('/show-checkout') }}"><i class="fa fa-crosshairs"></i> Thanh
                                        toán</a></li>
                                <?php } else { ?>
                                ...
                                <li><a href="{{ URL::to('/logout-checkout') }}"><i class="fa fa-unlock"></i> Đăng
                                        xuất</a></li>
                                <?php } else { ?>
