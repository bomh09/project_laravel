                        ...
                        @foreach ($all_brand as $key => $brand)
                            <tr>
                                ...
                                <td><span class="text-ellipsis">
                                        ...
                                        <a href="{{ URL::to('/hidden-brand/' . $brand->brand_id) }}"><span
                                                class="fa-thumb-styling fa fa-thumbs-up"></span></a>
                                        <?php } else { ?>
                                        <a href="{{ URL::to('/show-brand/' . $brand->brand_id) }}"><span
                                                class="fa-thumb-styling fa fa-thumbs-down"></span></a>
                                        <?php } ?>
                                    </span></td>
                                <td>
                                    <a href="{{ URL::to('/edit-brand/' . $brand->brand_id) }}" class="active"
                                        ui-toggle-class="">
                                        <i class="fa fa-pencil-square-o text-success text-active"></i>
                                    </a>
                                    <a onclick="return confirm('Bạn có muốn xóa thương hiệu này không ?')"
                                        href="{{ URL::to('/del-brand/' . $brand->brand_id) }}" class="active"
                                        ui-toggle-class="">
