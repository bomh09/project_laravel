                    ...
                    <tbody>
                        ...
                        @foreach ($all_product as $key => $product)
                            <tr>
                                ...
                                <td><img src="public/uploads/product/{{ $product->product_image }}" width="70px"
                                        height="70px" alt=""></td>
                                ...
                                <td><span class="text-ellipsis">
                                        ...
                                        <a href="{{ URL::to('/hidden-product/' . $product->product_id) }}"><span
                                ...
                                <td>
                                    ...
                                    <a onclick="return confirm('Bạn có muốn xóa sản phẩm này không ?')"
                                        href="{{ URL::to('/del-product/' . $product->product_id) }}" class="active"
                                        ui-toggle-class="">
