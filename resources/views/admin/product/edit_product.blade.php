                    ...
                    <div class="panel-body">
                        ...
                        <div class="position-center">
                            ...
                            <form role="form" method="POST"
                                action="{{ URL::to('/update-product/' . $edit_product->product_id) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="cat_id" class="form-control input-sm m-bot15">
                                        @foreach ($cat as $cat)
                                            @if ($cat->cat_id == $edit_product->cat_id)
                                                <option selected value="{{ $cat->cat_id }}">{{ $cat->cat_name }}
                                                </option>
                                            @else
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="product_price" value="{{ $edit_product->product_price }}"
                                        class="form-control" id="exampleInputEmail1" placeholder="Giá">
                                </div>
                                 <div class="form-group">
                                    <label for="exampleInputEmail1">Số lượng</label>
                                    <input type="text" name="product_quantity" value="{{ $edit_product->product_quantity }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea style="resize: none" rows="5" type="text" name="product_desc"
                                        class="form-control" id="pro_ckeditor1" placeholder="Mô tả">
