                        ...
                        @foreach ($all_cat as $key => $cat)
                            <tr>
                                ...
                                <td><span class="text-ellipsis">
                                        ...
                                        <a href="{{ URL::to('/hidden-cat/' . $cat->cat_id) }}"><span
                                                class="fa-thumb-styling fa fa-thumbs-up"></span></a>
                                        <?php } else { ?>
                                        <a href="{{ URL::to('/show-cat/' . $cat->cat_id) }}"><span
                                                class="fa-thumb-styling fa fa-thumbs-down"></span></a>
                                        <?php } ?>
                                    </span></td>
                                <td>
                                    <a href="{{ URL::to('/edit-cat/' . $cat->cat_id) }}" class="active"
                                        ui-toggle-class="">
                                        <i class="fa fa-pencil-square-o text-success text-active"></i>
                                    </a>
                                    <a onclick="return confirm('Bạn có muốn xóa danh mục này không ?')"
                                        href="{{ URL::to('/del-cat/' . $cat->cat_id) }}" class="active"
                                        ui-toggle-class="">
